...
- Branded event-pitch intake form on its own `pitch.html` page; the homepage opens it in a new tab and the form prepares a complete email to `DearEleanorMiami@gmail.com`
...
- `script.js` — navigation, section states, reveal animation, mobile menu, music, and homepage form feedback
- `pitch.html` / `pitch.js` — standalone event-pitch page and email handoff
